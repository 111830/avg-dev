...
void printPerson(Person *p)
{
    ...
    printf("%s %s, %i, %s\n",
           ...
           p->lastName,
           p->age,
           p->gender == MALE ? maleGander : femaleGender);
}
...
/**
 * This function will allocated memory in the heap to store a Person structure.
...
{
    Person *a = createPerson("Bob", "Peter", 43, MALE);
